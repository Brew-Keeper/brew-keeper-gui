    ...
    $http.get('https://brew-keeper-api.herokuapp.com/api/users/public/recipes/' + id + '/')
      ...
      $scope.nextStep = function(stepNumber, brewCount){
        ...
        if(nextStepIndex >= $scope.steps.length){
          ...
          // $http.patch('https://brew-keeper-api.herokuapp.com/api/users/public/recipes/' + id + '/', recipe);
          return
        }
...
//Change next step to green  and grow next step to 200
    ...
    //   $http.post('https://brew-keeper-api.herokuapp.com/api/users/public/recipes/' + id + '/brewnotes/', $scope.brewnote)
    ...
    //   $http.patch("https://brew-keeper-api.herokuapp.com/api/users/public/recipes/"+ id + "/", newRating)
    // }
